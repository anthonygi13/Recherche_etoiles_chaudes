...
def lines(filename, n_c1, n_c2, column_separator, begining_str, comentary_char):
    """
...
def get_magnitudes(filename, n_g_r, n_u_g, column_separator, begining_str, comentary_char):
    """
...
def find_hot_stars(input_file, output_file, n_g_r, n_u_g, column_separator, begining_str, comentary_char, output_folder=None):
    """
...
def fichier_reg(input_file, output_file, n_alpha, n_delta, column_separator, begining_str, comentary_char, output_folder=None, circle_size=5, circle_color="green"):
    """
    moi
...
def plot_u_g_vs_g_r(title, filename, n_g_r, n_u_g, column_separator, begining_str, comentary_char,
...
def save_plot(title, input_file, output_file, n_g_r, n_u_g, column_separator, begining_str, comentary_char, output_folder=None,
